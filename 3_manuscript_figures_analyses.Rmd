...
# change
levels(metadata$country_assessment)<-c("Australia", "Belgium", "Colombia", "France", "Japan", "Mexico", "South Africa", "Sweden", "US")
levels(indicators_full$country_assessment)<-c("Australia", "Belgium", "Colombia", "France", "Japan", "Mexico", "South Africa", "Sweden", "US")
levels(ind1_data$country_assessment)<-c("Australia", "Belgium", "Colombia", "France", "Japan", "Mexico", "South Africa", "Sweden", "US")
levels(ind2_data$country_assessment)<-c("Australia", "Belgium", "Colombia", "France", "Japan", "Mexico", "South Africa", "Sweden", "US")
levels(indicator1$country_assessment)<-c("Australia", "Belgium", "Colombia", "France", "Japan", "Mexico", "South Africa", "Sweden", "US")
...
df$facet <- factor(df$facet, levels=c("Australia", "Belgium", "Colombia", "France", "Japan", "Mexico", "South Africa", "Sweden", "US", "all"))
...
p5<-indicators_full %>%
  ...
  geom_bar(color="white") +
  scale_fill_manual(labels=c("Unknown", "Known"),
                    values=c("#ff7f0e", "#2ca02c")) + 
  labs(fill="Number of extinct populations") +
...
### Supplementary Figure: Missing data in extinct populations by country and method and by taxonomic group
...
pa<-indicators_full %>%
  ...
  theme_light() +
  theme(panel.border = element_blank(), legend.position="top") + ggtitle("a)")
 pa 
```
...
pb<-indicators_full %>%
  ...
  facet_wrap(country_assessment ~., nrow = 3, scales="free_x") +
  theme_light() +
  theme(panel.border = element_blank(), legend.position="none") + ggtitle("b)")
pb  
```
