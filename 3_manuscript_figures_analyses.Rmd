...
### Supplementary Figure: Ne and Nc data availabiltiy by taxa
```{r}
...
indicators_averaged_one %>% 
  # filter US and Mx
  filter(country_assessment %!in% c("Mexico", "USA", "Australia")) %>%
  filter(!is.na(regional_redlist)) %>%
...
## Supplementary Figure: Values of indicator 1 and indicator 2 for multiassessed taxa (alternative assessments)
