...
2) Explore the differences in the indicator value of the 24 taxa for which we have a different Ne:Nc ratio.
...
```
Same data in tidy format for plots and summaries:
```{r}
