...
# Note: This script assumes that 'kobo_output' is already loaded and available in your working environment.
# Please make sure that 'kobo_output' is defined and contains the necessary data before running the code.
...
process_files <- function(root_dir, target_dir) {
