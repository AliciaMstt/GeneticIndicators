...
Facet by country
```{r, out.width="500px", out.height="1500px"}
ind2_data_firstmulti %>% 
  ...
  theme_bw() +
  theme(panel.border = element_blank(), legend.position="none") + 
  facet_wrap(~country_assessment, ncol=1)
```
