...
Simplify combinations of methods to define populations. Keep only each method alone, plus "method_and_others" if it occurs in combination with any other.
...
# create new variable
ind2_data<- ind2_data %>% 
            mutate(defined_populations_simplified= defined_populations)

#mutate new variable to desired groups
ind2_data<- ind2_data %>% 
            mutate(defined_populations_simplified = ifelse(grepl("genetic_clusters ", 
                                                       defined_populations), "genetic_clusters_and_others",
                                                       defined_populations_simplified)) %>% 
            mutate(defined_populations_simplified = ifelse(grepl("geographic_boundaries ", 
                                                       defined_populations_simplified), "geographic_boundaries_and_others",
                                                       defined_populations_simplified)) %>% 
            mutate(defined_populations_simplified = ifelse(grepl("eco_biogeo_proxies ", 
                                                       defined_populations_simplified), "eco_biogeo_proxies_and_others",
                                                       defined_populations_simplified)) %>%
            mutate(defined_populations_simplified = ifelse(grepl("adaptive_traits ", 
                                                       defined_populations_simplified), "adaptive_traits_and_others",
                                                       defined_populations_simplified)) %>%
            mutate(defined_populations_simplified = ifelse(grepl("management_units ", 
                                                       defined_populations_simplified), "management_units_and_others",
                                                       defined_populations_simplified)) %>%
            mutate(defined_populations_simplified = ifelse(grepl("other ", 
                                                       defined_populations_simplified), "other_and_others",
                                                       defined_populations_simplified))
### for metadata
