...
df<-data.frame()
for(i in c(1:2, 11,13, 16:17, 18:20, 21, 22:28, 31:33,34,35)){ # change numbers to reflect indexes of the files with the desired delim in result_files[i]
