...
ggplot(metadata, aes(x=country_assessment)) + 
  geom_bar(stat = "count") +
  ggtitle("Number of records assessedd by country, \nincluding taxa assed more than once")
...
**Now check taxa assessed excluding duplicates, i.e. the real number of taxa assessed:**
