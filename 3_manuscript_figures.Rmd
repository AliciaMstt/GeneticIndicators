...
p3<-ind1_data %>%
  ...
  coord_flip() + 
  scale_fill_discrete(labels=c("Point Nc estimate", "Quantitative Nc range \nor qualitative data", "Unknown Nc \nfor this pop."),
...
```{r, out.width="1600px", out.height="400px"}
p2<- p2 + theme(axis.text.y=element_blank())
p3<- p3 + theme(axis.text.y=element_blank())

# plot
plot_grid(p1, p2, p3, ncol=3, rel_widths = c(1.4,1,1), align = "h")  
```
