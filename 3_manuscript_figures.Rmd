...
### Proportion of maintained populations (indicator) (proportion of populations within species which are maintained)
...
### Number of maintained populations by method
...
### Proportion of maintained populations (indicator) by method
...
## plot for Proportion of maintained populations (indicator) without axis labels
p2<-ind2_data %>% 
  filter(n_extant_populations<500) %>%
